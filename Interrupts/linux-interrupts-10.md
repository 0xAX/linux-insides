...
This is the tenth part of the [chapter](https://linux-insides.gitbook.io/linux-insides/Interrupts/index.html) about interrupts and interrupt handling in the Linux kernel and in the previous [part](https://linux-insides.gitbook.io/linux-insides/Interrupts/linux-interrupts-9.html) we saw a little about deferred interrupts and related concepts like `softirq`, `tasklet` and `workqeue`. In this part we will continue to dive into this theme and now it's time to look at real hardware driver.
...
More about `kzalloc` will be in the separate chapter about [memory management](https://linux-insides.gitbook.io/linux-insides/MM/index.html) in the Linux kernel. As we allocated space for the `irqaction`, we start to initialize this structure with the values of interrupt handler, interrupt flags, device name, etc:
...
* [memory management](https://linux-insides.gitbook.io/linux-insides/MM/index.html)
...
* [Previous part](https://linux-insides.gitbook.io/linux-insides/Interrupts/linux-interrupts-9.html)
