...
where `NR_VECTORS` is count of the vector number and as you can remember from the first [part](https://linux-insides.gitbook.io/linux-insides/Interrupts/linux-interrupts-1.html) of this chapter it is `256` for the [x86_64](https://en.wikipedia.org/wiki/X86-64):

```C
#define NR_VECTORS                       256
```

So, in the start of the `init_IRQ` function we fill the `vector_irq` [percpu](https://linux-insides.gitbook.io/linux-insides/Concepts/linux-cpu-1.html) array with the vector number of the `legacy` interrupts:
...
This function makes initialization of the [APIC](https://en.wikipedia.org/wiki/Advanced_Programmable_Interrupt_Controller) of `bootstrap processor` (or processor which starts first). It starts from the check that we found [SMP](https://en.wikipedia.org/wiki/Symmetric_multiprocessing) config (read more about it in the sixth [part](https://linux-insides.gitbook.io/linux-insides/Initialization/linux-initialization-6.html) of the Linux kernel initialization process chapter) and the processor has `APIC`:
...
You can remember how we did it in the sixth [part](https://linux-insides.gitbook.io/linux-insides/Interrupts/linux-interrupts-6.html) of this chapter.
...
* [Previous part](https://linux-insides.gitbook.io/linux-insides/Interrupts/linux-interrupts-7.html)
