...
* [SMP]()
* [Kernel mechanisms](Concepts/README.md)
...
* [Toolchain and binaries](Toolchain/README.md)
    * [How the kernel is compiled](Toolchain/linux-toolchain-1.md)
    * [Linkers](Toolchain/linux-toolchain-2.md)
    * [Executable and Linkable Format](Toolchain/linux-toolchain-3.md)
    * [Inline assembly](Toolchain/linux-toolchain-4.md)
    * [Program startup process in userspace](Toolchain/linux-toolchain-5.md)
* [Initial ram disk]()
   * [initrd]()
* [Contributing to the Linux kernel](Contributing/linux-contributing-1.md)
