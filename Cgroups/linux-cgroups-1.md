...
This is the first part of the new chapter of the [linux insides](https://linux-insides.gitbook.io/linux-insides/) book and as you may guess by part's name - this part will cover [control groups](https://en.wikipedia.org/wiki/Cgroups) or `cgroups` mechanism in the Linux kernel.
...
* [Previous chapter](https://linux-insides.gitbook.io/linux-insides/MM/linux-mm-1.html)
