...
This is the first part of the new chapter of the [linux insides](https://proninyaroslav.gitbooks.io/linux-insides-ru/content/) book and as you may guess by part's name - this part will cover [control groups](https://en.wikipedia.org/wiki/Cgroups) or `cgroups` mechanism in the Linux kernel.
...
* [Previous chapter](https://proninyaroslav.gitbooks.io/linux-insides-ru/content/MM/linux-mm-1.html)
