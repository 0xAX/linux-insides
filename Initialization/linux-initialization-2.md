...
In the previous [part](https://linux-insides.gitbook.io/linux-insides/Initialization/linux-initialization-1.html) we stopped before setting of early interrupt handlers. At this moment we are in the decompressed Linux kernel, we have basic [paging](https://en.wikipedia.org/wiki/Page_table) structure for early boot and our current goal is to finish early preparation before the main kernel code will start to work.

We already started to do this preparation in the previous [first](https://linux-insides.gitbook.io/linux-insides/Initialization/linux-initialization-1.html) part of this [chapter](https://linux-insides.gitbook.io/linux-insides/Initialization/index.html). We continue in this part and will know more about interrupt and exception handling.
...
* [Previous part](https://linux-insides.gitbook.io/linux-insides/Initialization/linux-initialization-1.html)
