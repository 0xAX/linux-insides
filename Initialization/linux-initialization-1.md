...
If `_text` address is not aligned for `2` megabytes, we enter infinite loop. The `PMD_PAGE_MASK` indicates the mask for `Page middle directory` (read [Paging](https://linux-insides.gitbook.io/linux-insides/Theory/linux-theory-1.html) about it) and is defined as:
...
You can read more about it in the [Paging](https://linux-insides.gitbook.io/linux-insides/Theory/linux-theory-1.html) part.
...
* [Previous part - kernel load address randomization](https://linux-insides.gitbook.io/linux-insides/Booting/linux-bootstrap-6.html)
